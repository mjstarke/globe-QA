...
########################################################################################################################
ax = plotters.plot_annotated_heatmap(absolute_jan, geos_labels, globe_labels, text_color_threshold=1000, figsize=(6, 7))
ax.set_xlabel("GEOS total cloud cover")
ax.set_ylabel("GLOBE total cloud cover")
plt.tight_layout()

ax = plotters.plot_annotated_heatmap(columnwise_jan, geos_labels, globe_labels, text_color_threshold=0.5, figsize=(6, 7), text_formatter="{:.2%}")
ax.set_xlabel("GEOS total cloud cover")
ax.set_ylabel("GLOBE total cloud cover")
plt.tight_layout()

ax = plotters.plot_annotated_heatmap(rowwise_jan, geos_labels, globe_labels, text_color_threshold=0.5, figsize=(6, 7), text_formatter="{:.2%}")
ax.set_xlabel("GEOS total cloud cover")
ax.set_ylabel("GLOBE total cloud cover")
plt.tight_layout()
...
########################################################################################################################
ax = plotters.plot_annotated_heatmap(absolute_jul, geos_labels, globe_labels, text_color_threshold=800, figsize=(6, 7))
ax.set_xlabel("GEOS total cloud cover")
ax.set_ylabel("GLOBE total cloud cover")
plt.tight_layout()

ax = plotters.plot_annotated_heatmap(columnwise_jul, geos_labels, globe_labels, text_color_threshold=0.4, figsize=(6, 7), text_formatter="{:.2%}")
ax.set_xlabel("GEOS total cloud cover")
ax.set_ylabel("GLOBE total cloud cover")
plt.tight_layout()

ax = plotters.plot_annotated_heatmap(rowwise_jul, geos_labels, globe_labels, text_color_threshold=0.4, figsize=(6, 7), text_formatter="{:.2%}")
ax.set_xlabel("GEOS total cloud cover")
ax.set_ylabel("GLOBE total cloud cover")
plt.tight_layout()
...
########################################################################################################################
ax = plotters.plot_annotated_heatmap(absolute_jul - absolute_jan, geos_labels, globe_labels, text_color_threshold=-600,
                                     figsize=(6, 7), cmap="bwr", vmin=-1000., vmax=1000.)
ax.set_xlabel("GEOS total cloud cover")
ax.set_ylabel("GLOBE total cloud cover")
plt.tight_layout()

ax = plotters.plot_annotated_heatmap(columnwise_jul - columnwise_jan, geos_labels, globe_labels, text_color_threshold=-5,
                                     figsize=(6, 7), cmap="bwr", text_formatter="{:.2%}", vmin=-.3, vmax=.3)
ax.set_xlabel("GEOS total cloud cover")
ax.set_ylabel("GLOBE total cloud cover")
plt.tight_layout()

ax = plotters.plot_annotated_heatmap(rowwise_jul - rowwise_jan, geos_labels, globe_labels, text_color_threshold=-.2,
                                     figsize=(6, 7), cmap="bwr", text_formatter="{:.2%}", vmin=-.3, vmax=.3)
ax.set_xlabel("GEOS total cloud cover")
ax.set_ylabel("GLOBE total cloud cover")
plt.tight_layout()
